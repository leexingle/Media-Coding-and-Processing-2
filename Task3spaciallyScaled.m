...
translatedImage = imread('spatiallyScaled.png');

% Ensure the image is grayscale
if size(translatedImage, 3) == 3
    inputImage = rgb2gray(translatedImage); % Convert RGB to grayscale

else
    inputImage = translatedImage;
end
